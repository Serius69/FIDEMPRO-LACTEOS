    ...
    if ((e.preventDefault(), form.checkValidity())) {
      var t = document.getElementById("dealTitle").value,
        ...
        o =
          `<div class="card">
                            <div class="card-body">
                                <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#` +
          t +
          ...
          `</p>
                            ...
                            <div class="collapse border-top border-top-dashed" id="` +
          t +
          `">
                                <div class="card-body">
                                <h6 class="fs-14 mb-1">` +
          l +
          ` <small class="badge bg-danger-subtle text-danger">4 Days</small></h6>
                                    <p class="text-muted">` +
          c +
          `</p>
                                ...
                                <div class="card-footer hstack gap-2">
                                    <button class="btn btn-warning btn-sm w-100" data-bs-toggle="tooltip" data-bs-placement="top" title="` +
          i +
          `"><i class="ri-phone-line align-bottom me-1"></i> Call</button>
                                    <button class="btn btn-info btn-sm w-100" data-bs-toggle="tooltip" data-bs-placement="top" title="` +
          n +
