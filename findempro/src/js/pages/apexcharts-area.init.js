...
for (
  var timelinechart,
    ...
    areachartSplineColors =
      ...
      getChartColorsArray("area_chart_spline")),
    areachartDatetimeColors =
      ...
      getChartColorsArray("area_chart_datetime")),
    resetCssClasses =
      (areachartDatetimeColors &&
        ((timelinechart = {
          series: [
    ...
    areachartNegativeColors =
      ...
      getChartColorsArray("area_chart_negative")),
    areachartMonthsColors =
      (areachartNegativeColors &&
        ((options = {
          series: [
            {
      ...
      getChartColorsArray("area_chart-months")),
    areachartyearsColors =
      (areachartMonthsColors &&
        ((options = {
      ...
      getChartColorsArray("area_chart-years")),
...
areachartirregularColors &&
  ...
  (areachartirregularColors = getChartColorsArray("area-missing-null-value")) &&
    ((options = {
      series: [
        {
          name: "Network",
