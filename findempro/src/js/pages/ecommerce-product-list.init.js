var productListAllData = [
    {
      id: 1,
      product: {
        img: "/static/images/products/img-1.webp",
    ...
    },
    {
      id: 2,
      product: {
        img: "/static/images/products/img-2.webp",
    ...
    },
    {
      id: 3,
      product: {
        img: "/static/images/products/img-3.webp",
    ...
    },
    {
      id: 4,
      product: {
        img: "/static/images/products/img-4.webp",
    ...
    },
    {
      id: 5,
      product: {
        img: "/static/images/products/img-5.webp",
    ...
    },
    {
      id: 6,
      product: {
        img: "/static/images/products/img-6.webp",
    ...
    },
    {
      id: 7,
      product: {
        img: "/static/images/products/img-7.webp",
    ...
    },
    {
      id: 8,
      product: {
        img: "/static/images/products/img-8.webp",
    ...
    },
    {
      id: 9,
      product: {
        img: "/static/images/products/img-9.webp",
    ...
    },
    {
      id: 10,
      product: {
        img: "/static/images/products/img-10.webp",
      ...
      function (r) {
        r.addEventListener("click", function () {
          ...
          productListAll.updateConfig({ data: e }).forceRender(),
            productListPublished.updateConfig({ data: i }).forceRender(),
            checkRemoveItem();
        });
      },
    ),
  ...
  filterChoicesInput =
    (slider.noUiSlider.on("update", function (e, t) {
      var i = productListAllData,
        ...
        s = minCostInput.value.substr(2);
      (filterDataAll = i.filter(
        (e) => parseFloat(e.price) >= s && parseFloat(e.price) <= a,
      )),
  ...
  searchBrandsOptions =
    (Array.from(
      ...
      (r.querySelector(".filter-badge").innerHTML = a),
      ...
      (a = r.getAttribute("data-id")),
        document
          ...
          .addEventListener("click", function () {
            ...
            var t = e(productListAllData, a),
              i = e(productListPublishedData, a);
