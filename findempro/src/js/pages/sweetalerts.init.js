document.getElementById("sa-basic") &&
  ...
  document.getElementById("sa-image") &&
    document.getElementById("sa-image").addEventListener("click", function () {
      Swal.fire({
        ...
        imageUrl: "/static/images/logo-sm.webp",
        imageHeight: 40,
        confirmButtonClass: "btn btn-primary w-xs mt-2",
        buttonsStyling: !1,
        animation: !1,
    ...
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          ...
          icon: "info",
          html: 'You can use <b>bold text</b>, <a href="//Sergio Troche.in/">links</a> and other HTML tags',
          showCloseButton: !0,
          showCancelButton: !0,
    ...
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          ...
          confirmButtonClass: "btn btn-primary w-xs",
          buttonsStyling: !1,
          background: "#fff url(/static/images/chat-bg-pattern.webp)",
        });
      }),
  ...
  document.getElementById("custom-sa-notification") &&
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          html: '<div class="mt-3"><div class="avatar-lg mx-auto"><img src="/static/images/users/avatar-2.webp" class="rounded-circle img-thumbnail" alt="thumbnail"></div><div class="mt-4 pt-2 fs-15"><h4 class="fs-18 fw-semibold">Welcome <span class="fw-semibold">Mike Mayer</span></h4><p class="text-muted mb-0 fs-13">You have <span class="fw-semibold text-success">2</span> Notifications</p></div></div>',
          showCancelButton: !1,
          confirmButtonClass: "btn btn-primary mb-1",
          confirmButtonText:
