...
var options,
  ...
  chartTimelineColors =
    ...
    getChartColorsArray("color_timeline")),
  chartTimelineMultiSeriesColors =
    (chartTimelineColors &&
      ((options = {
        series: [
          {
    ...
    getChartColorsArray("multi_series")),
  chartTimelineAdvancedColors =
    (chartTimelineMultiSeriesColors &&
      ((options = {
        series: [
          {
    ...
    getChartColorsArray("advanced_timeline")),
  chartMultiSeriesGroupColors =
    (chartTimelineAdvancedColors &&
      ((options = {
        series: [
          {
    ...
    getChartColorsArray("multi_series_group")),
  dumbbellChartColors =
    (chartMultiSeriesGroupColors &&
      ((options = {
        series: [
        ...
        chart: { height: 350, type: "rangeBar", toolbar: { show: !1 } },
        plotOptions: {
          bar: { horizontal: !0, barHeight: "35%", rangeBarGroupRows: !0 },
        },
