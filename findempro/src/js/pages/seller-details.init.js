...
TableProductListAll &&
  new gridjs.Grid({
    columns: [
      ...
      },
      {
        ...
        formatter: function (e) {
          return gridjs.html(
            '<div class="d-flex align-items-center"><div class="flex-shrink-0 me-3"><div class="avatar-sm bg-light rounded p-1"><img src="/static/images/products/' +
              e[0] +
    ...
    data: [
      [
        ["img-1.webp", "Half Sleeve Round Neck T-Shirts", "Clothes"],
        "12",
        "$ 115.00",
        "48",
        "4.2",
      ...
      [
        ["img-2.webp", "Urban Ladder Pashe Chair", "Furniture"],
        "06",
        "$ 160.00",
        "30",
        "4.3",
      ...
      [
        ["img-4.webp", "Fabric Dual Tone Living Room Chair", "Furniture"],
        "15",
        "$ 140.00",
        "40",
        "4.2",
      ...
      [
        ["img-5.webp", "Crux Motorsports Helmet", "Bike Accessories"],
        "08",
        "$ 135.00",
        "55",
        "4.4",
      ...
      [
        ["img-6.webp", "Half Sleeve T-Shirts (Blue)", "Clothes"],
        "15",
        "$ 125.00",
        "48",
        "4.2",
      ...
      [
        ["img-7.webp", "Noise Evolve Smartwatch", "Watches"],
        "12",
        "$ 95.00",
        "45",
        "4.3",
      ...
      [
        ["img-8.webp", "Sweatshirt for Men (Pink)", "Clothes"],
        "20",
        "$ 120.00",
        "48",
        "4.2",
