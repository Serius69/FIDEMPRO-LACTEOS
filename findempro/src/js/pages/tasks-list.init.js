    ...
    Array.from(t.slice(0, 3)).forEach(function (e) {
      ...
      tasksList.add({
        id:
          ...
          "</a>",
        project_name:
          '<a href="apps-products-overview.html" class="fw-medium link-primary">' +
          e.project_name +
          "</a>",
            ...
            ? (e.preventDefault(),
              ...
              editlist
                ? "" !== projectNameField.value &&
                  ...
                  "" !== statusField.value &&
                  editlist &&
                  ((t = tasksList.get({ id: idField.value })),
...
function SearchData() {
  ...
  tasksList.filter(function (e) {
    var t = (matchData = new DOMParser().parseFromString(
      ...
      a = "all" == t || "all" == i || t == i,
      s =
        new Date(e.values().due_date.slice(0, 12)) >= new Date(n) &&
    ...
    editBtns &&
      Array.from(editBtns).forEach(function (e) {
        e.addEventListener("click", function (e) {
          ...
          Array.from(e).forEach(function (e) {
            var t,
              a = (isid = new DOMParser().parseFromString(
                e._values.id,
                "text/html",
              )).body.firstElementChild.innerHTML;
            a == itemId &&
              ((editlist = !0),
              (idField.value = a),
              (a = (project = new DOMParser().parseFromString(
              ...
              Array.from(
                document.querySelectorAll('input[name="assignedTo[]"]'),
              ).forEach(function (t) {
                var a = t.parentElement.querySelector(".flex-grow-1").innerHTML;
                new DOMParser()
                  .parseFromString(e._values.assignedto, "text/html")
                  .querySelectorAll(".avatar-group .avatar-group-item")
                  .forEach(function (e) {
              ...
              (a = (val = new DOMParser().parseFromString(
                e._values.priority,
                "text/html",
              )).body.firstElementChild.innerHTML),
              example.setChoiceByValue(a),
...
function clearFields() {
  (projectNameField.value = ""),
    ...
    (dateDueField.value = ""),
    document
      .querySelectorAll('input[name="assignedTo[]"]')
      .forEach(function (e) {
        e.checked = !1;
      }),
    example && example.destroy(),
