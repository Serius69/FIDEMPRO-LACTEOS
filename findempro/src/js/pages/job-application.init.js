...
(xhttp.onload = function () {
  ...
  Array.from(e).forEach(function (e) {
    applicationList.add({
      id: '<a href="#" class="fw-medium link-primary">#VZ' + e.id + "</a>",
      company:
        '<div class="d-flex align-items-center">            <div class="flex-shrink-0">            <img src="' +
        e.company[0] +
        '" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">            </div>            <div class="flex-grow-1 ms-2 name">' +
        e.company[1] +
        "</div>        </div>",
    ...
    applicationList.remove(
      "id",
      '<a href="#" class="fw-medium link-primary">#VZ001</a>',
    );
}),
      ...
      a.checkValidity()
        ? (e.preventDefault(),
          ...
          editlist
            ...
            : (applicationList.add({
                id:
                  '<a href="#" class="fw-medium link-primary">#VZ' +
                  count +
                  "</a>",
                company:
                  '<div class="d-flex align-items-center">                    <div class="flex-shrink-0">                        <img src="' +
