...
var chartCandlestickBasicColors = getChartColorsArray("basic_candlestick"),
  chartCandlestickComboColors =
    (chartCandlestickBasicColors &&
      ((options = {
        series: [
          {
            data: [
    ...
    getChartColorsArray("combo_candlestick"));
chartCandlestickComboColors &&
  ((options = {
...
(chartCandlestickComboColors = getChartColorsArray(
...
var optionsBar,
  ...
  chartCandlestickLineColors =
    (chartCandlestickCategoryColors &&
      ((options = {
        series: [
          {
            name: "candle",
    ...
    getChartColorsArray("candlestick_with_line"));
chartCandlestickLineColors &&
  ((options = {
    series: [
      {
