  ...
  Array.from(e).forEach(function (e) {
    ...
    Array.from(t).forEach((e, t) => {
      ...
      contactList.add({
        ...
        name:
          '<div class="d-flex align-items-center">            <div class="flex-shrink-0"><img src="' +
          e.name[0] +
          '" alt="" class="avatar-xs rounded-circle"></div>            <div class="flex-grow-1 ms-2 name">' +
          e.name[1] +
          "</div>            </div>",
          ...
          Array.from(e).forEach(function (e) {
            ...
            t == itemId &&
              ...
              (customerImg.src = new DOMParser()
                .parseFromString(e._values.name, "text/html")
...
function clearFields() {
  (customerImg.src = "/static/images/users/user-dummy-img.webp"),
        ...
        ? (e.preventDefault(),
          ...
          editlist
            ? "" !== customerNameField.value &&
              ...
              "" !== designationField.value &&
              editlist &&
              ((t = contactList.get({ id: idField.value })),
                  ...
                  t == itemId &&
                    e.values({
                      ...
                      name:
                        '<div class="d-flex align-items-center">                            <div class="flex-shrink-0"><img src="' +
                        customerImg.src +
                        '" alt="" class="avatar-xs rounded-circle object-fit-cover"></div>                            <div class="flex-grow-1 ms-2 name">' +
                        customerNameField.value +
                        "</div>                            </div>",
            ...
            : ((t = tagInputField.getValue(!0)),
              ...
              contactList.add({
                ...
                name:
                  '<div class="d-flex align-items-center">                    <div class="flex-shrink-0"><img src="' +
                  customerImg.src +
                  '" alt="" class="avatar-xs rounded-circle object-cover"></div>                    <div class="flex-grow-1 ms-2 name">' +
                  customerNameField.value +
                  "</div>                    </div>",
                company_name: company_nameField.value,
                designation: designationField.value,
