      ...
      el.addEventListener("click", function (e) {
        ...
        var e = el.closest(".card"),
          t =
            ...
            e.getElementsByClassName("card-preloader")[0]);
        setTimeout(
          function () {
            t.remove();
          },
  ...
  growingLoader =
    ...
    function () {
      (element = document.querySelector(
        '.card a[data-toggle="growing-reload"]',
      )) &&
      ...
      (customLoader1 = document.querySelector(
        ...
        customLoader1.addEventListener("click", function (e) {
          ...
          var e = customLoader1.closest(".card"),
            t =
              ((insertEl =
                '<div class="card-preloader"><div class="card-status"><img src="/static/images/logo-sm.webp" alt="" class="img-fluid custom-loader"></div></div>'),
              e.children[1].insertAdjacentHTML("beforeend", insertEl),
              e.getElementsByClassName("card-preloader")[0]);
          setTimeout(
            function () {
