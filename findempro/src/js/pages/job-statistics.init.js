...
areachartbitcoinColors &&
  ((options = {
    series: [{ name: "Results", data: [0, 36, 110, 95, 130] }],
    chart: {
      width: 140,
      type: "area",
      sparkline: { enabled: !0 },
  ...
  (areachartbitcoinColors = getChartColorsArray("results_sparkline_charts3")) &&
    ((options = {
      series: [{ name: "Results", data: [0, 110, 95, 75, 120] }],
      chart: {
        width: 140,
        type: "area",
        sparkline: { enabled: !0 },
...
(areachartbitcoinColors = getChartColorsArray("results_sparkline_charts4")) &&
  ((options = {
  ...
  (chart = new ApexCharts(
    document.querySelector("#results_sparkline_charts4"),
    options,
  )).render());
var options,
  chart,
  ...
  revenueExpensesChartsColors =
    (dealTypeChartsColors &&
      ((options = {
        series: [
          { name: "Following", data: [80, 50, 30, 40, 100, 20] },
          { name: "Followers", data: [20, 30, 40, 80, 20, 80] },
        ],
        chart: {
          height: 341,
          type: "radar",
