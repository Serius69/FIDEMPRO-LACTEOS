...
function loadCharts() {
  var e = getChartColorsArray("chart-seller1"),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller1"), e).render()),
      getChartColorsArray("chart-seller2")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller2"), e).render()),
      getChartColorsArray("chart-seller3")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller3"), e).render()),
      getChartColorsArray("chart-seller4")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller4"), e).render()),
      getChartColorsArray("chart-seller5")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller5"), e).render()),
      getChartColorsArray("chart-seller6")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller6"), e).render()),
      getChartColorsArray("chart-seller7")),
    e =
      (e &&
        ((e = {
        ...
        new ApexCharts(document.querySelector("#chart-seller7"), e).render()),
      getChartColorsArray("chart-seller8"));
  e &&
    ((e = {
  ...
  for (
    ...
    e[n] &&
      ((a = e[n].trending
        ...
        : ""),
      (document.getElementById("seller-list").innerHTML +=
        '<div class="col-xl-3 col-lg-6">        <div class="card ribbon-box right overflow-hidden">            <div class="card-body text-center p-4">                ' +
        a +
        '                <img src="' +
        e[n].shop[0].img +
        '" alt="' +
        e[n].shop[0].img_alt +
        '" height="45">                <h5 class="mb-1 mt-4"><a href="/apps-ecommerce-seller-details" class="link-primary">' +
        e[n].shop[0].name +
        '</a></h5>                <p class="text-muted mb-4">' +
        e[n].seller +
        '</p>                <div class="row justify-content-center">                    <div class="col-lg-8">                        <div id="chart-seller' +
        e[n].id +
        '" data-colors=\'["' +
        e[n].chartColor +
        '"]\'  dir="ltr"></div>                    </div>                </div>                <div class="row mt-4">                    <div class="col-lg-6 border-end-dashed border-end">                        <h5>' +
        e[n].stock +
        '</h5>                        <span class="text-muted">Item Stock</span>                    </div>                    <div class="col-lg-6">                        <h5>' +
        e[n].wallet_balance +
        '</h5>                        <span class="text-muted">Wallet Balance</span>                    </div>                </div>                <div class="mt-4">                    <a href="/apps-ecommerce-seller-details" class="btn btn-light w-100">View Details</a>                </div>            </div>        </div>    </div>'));
  paginationEvents(),
    pageEvent(e),
    selectedPage(),
    1 == currentPage
