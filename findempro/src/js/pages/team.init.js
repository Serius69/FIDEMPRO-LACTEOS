  ...
  (document.querySelector("#team-member-list").innerHTML = ""),
    Array.from(e).forEach(function (e, t) {
      ...
      (document.querySelector("#team-member-list").innerHTML +=
        ...
        e.position +
        '</p>                                </div>                            </div>                        </div>                        <div class="col-lg-4 col">                            <div class="row text-muted text-center">                                <div class="col-6 border-end border-end-dashed">                                    <h5 class="mb-1 products-num">' +
        e.products +
        '</h5>                                    <p class="text-muted mb-0">products</p>                                </div>                                <div class="col-6">                                    <h5 class="mb-1 tasks-num">' +
        e.tasks +
        '</h5>                                    <p class="text-muted mb-0">Tasks</p>                                </div>                            </div>                        </div>                        <div class="col-lg-2 col">                            <div class="text-end">                                <a href="profile.html" class="btn btn-light view-btn">View Profile</a>                            </div>                        </div>                    </div>                </div>            </div>        </div>'),
        bookmarkBtn(),
        editMemberList(),
        removeItem(),
        memberDetailShow();
            ...
            e.id == r &&
              ...
              "" == e.memberImg
                ? (document.getElementById("member-img").src =
                    "/static/images/users/user-dummy-img.webp")
              ...
              (document.getElementById("project-input").value = e.products),
    ...
    a.querySelector(".member-name").addEventListener("click", function () {
      var e = a.querySelector(".member-name h5").innerHTML,
        ...
        r = a.querySelector(".member-img")
          ...
          : "/static/images/users/user-dummy-img.webp",
        i = a.querySelector(".team-cover img").src,
        m = a.querySelector(".products-num").innerHTML,
        n = a.querySelector(".tasks-num").innerHTML;
      (document.querySelector("#member-overview .profile-img").src = r),
        (document.querySelector("#member-overview .team-cover img").src = i),
      ...
      e.addEventListener("click", function (e) {
        (document.getElementById("createMemberLabel").innerHTML =
          ...
          (document.getElementById("cover-img").src =
            "/static/images/small/img-9.webp"),
          (document.getElementById("member-img").src =
            "/static/images/users/user-dummy-img.webp"),
          document
            .getElementById("memberlist-form")
        ...
        function (e) {
          ...
          s.checkValidity()
            ? (e.preventDefault(),
              ...
              (i = document.getElementById("member-img").src),
              (m = document.getElementById("cover-img").src),
              (n =
                "/static/images/users/user-dummy-img.webp" ==
                i.substring(i.indexOf("/as") + 1)
                  ? ""
                  : i),
              (a = t
                .match(/\b(\w)/g)
