...
function C(t) {
  ((!t.__d && (t.__d = !0) && d.push(t) && !E.__r++) ||
    h !== c.debounceRendering) &&
    ((h = c.debounceRendering) || setTimeout)(E);
}
function E() {
  for (var t; (E.__r = d.length); )
...
function I(t, n, e, r, o, i, u, s, a, l) {
  ...
  for (e.__e = _, c = b; c--; ) null != y[c] && U(y[c], y[c]);
  if (g) for (c = 0; c < g.length; c++) O(g[c], g[++c], g[++c]);
}
function T(t, n, e) {
  for (var r, o = t.__k, i = 0; o && i < o.length; i++)
    (r = o[i]) &&
      ((r.__ = t),
      (n = "function" == typeof r.type ? T(r, n, e) : L(e, r, r, o, r.__e, n)));
  return n;
}
...
function H(t, n, e, r, o) {
  ...
  t: if ("style" === n)
    if ("string" == typeof e) t.style.cssText = e;
      ...
      if (e) for (n in e) (r && e[n] === r[n]) || A(t.style, n, e[n]);
    }
  else if ("o" === n[0] && "n" === n[1])
    (i = n !== (n = n.replace(/Capture$/, ""))),
      ...
      (t.l[n + i] = e),
      e
        ? r || t.addEventListener(n, i ? D : j, i)
        : t.removeEventListener(n, i ? D : j, i);
  ...
  try {
    t: if ("function" == typeof E) {
      ...
      (f.state = f.__s),
        ...
        (C = null != l && l.type === k && null == l.key ? l.props.children : l),
...
function U(t, n, e) {
  ...
  if (
    ...
    (r = t.ref) && ((r.current && r.current !== t.__e) || O(r, null, n)),
    null != (r = t.__c))
  ) {
  ...
  if ((r = t.__k))
    for (o = 0; o < r.length; o++)
      r[o] && U(r[o], n, e || "function" != typeof t.type);
...
(l = v.slice),
  ...
  (S.prototype.setState = function (t, n) {
    ...
    (e =
      ...
      t && y(e, t),
      null != t && this.__v && (n && this._sb.push(n), C(this));
  }),
  (S.prototype.forceUpdate = function (t) {
    this.__v && ((this.__e = !0), t && this.__h.push(t), C(this));
  }),
  (S.prototype.render = k),
  (d = []),
  (E.__r = 0),
  (_ = 0);
var z = /*#__PURE__*/ (function () {
  function t(t) {
    (this._id = void 0), (this._id = t || q());
  }
  return (
    n(t, [
      {
...
function $(t, n) {
  return w(V, { content: t, parentElement: n });
}
var G,
  ...
  Z = /*#__PURE__*/ (function (t) {
    function e(n) {
      ...
      return (
        ...
        (e._length = void 0),
        (e.rows = n instanceof Array ? n : n instanceof X ? [n] : []),
        e
      );
    }
    return (
...
var et,
  ...
  ht = c.unmount;
function _t(t, n) {
  c.__h && c.__h(rt, t, st || n), (st = 0);
  var e = rt.__H || (rt.__H = { __: [], __h: [] });
  return t >= e.__.length && e.__.push({ __V: lt }), e.__[t];
}
function mt(t) {
  return (
    (st = 1),
    (function (t, n, e) {
      ...
      if (
        ...
        rt.u = !0;
        var o = rt.shouldComponentUpdate;
        rt.shouldComponentUpdate = function (t, n, e) {
...
function vt(t, n) {
  var e = _t(et++, 3);
  !c.__s && Nt(e.__H, n) && ((e.__ = t), (e.i = n), rt.__H.__h.push(e));
}
function gt(t) {
  return (
    (st = 5),
...
function yt(t, n) {
  var e = _t(et++, 7);
  return Nt(e.__H, n) ? ((e.__V = t()), (e.i = n), (e.__h = t), e.__V) : e.__;
}
function bt() {
  for (var t; (t = at.shift()); )
    if (t.__P && t.__H)
      try {
        t.__H.__h.forEach(kt), t.__H.__h.forEach(St), (t.__H.__h = []);
      } catch (n) {
  ...
  (c.__r = function (t) {
    ...
    n &&
      (ot === rt
        ...
        : (n.__h.forEach(kt), n.__h.forEach(St), (n.__h = []))),
      (ot = rt);
  }),
  (c.diffed = function (t) {
    pt && pt(t);
    ...
    n &&
      n.__H &&
      (n.__H.__h.length &&
        ((1 !== at.push(n) && it === c.requestAnimationFrame) ||
          ((it = c.requestAnimationFrame) || xt)(bt)),
...
function xt(t) {
  var n,
    e = function () {
      clearTimeout(r), wt && cancelAnimationFrame(n), setTimeout(t);
    },
    r = setTimeout(e, 100);
  wt && (n = requestAnimationFrame(e));
}
function kt(t) {
  var n = rt,
    e = t.__c;
  "function" == typeof e && ((t.__c = void 0), e()), (rt = n);
}
function St(t) {
  var n = rt;
  (t.__c = t.__()), (rt = n);
...
function Ct() {
  return (function (t) {
    var n = rt.context[t.__c],
      e = _t(et++, 9);
    return (
      (e.c = t),
      n ? (null == e.__ && ((e.__ = !0), n.sub(rt)), n.props.value) : t.__
    );
  })(ln);
}
var Et = {
...
function jt() {
  ...
  var l,
    ...
    p = (function (t, n) {
      ...
      ((l = function (t) {
        t.target instanceof HTMLInputElement && s(Lt(t.target.value));
      }),
      (c = e instanceof ut ? i.debounceTimeout || 250 : 0),
      function () {
        var t = arguments;
  ...
  return w(
    ...
    {
      className: tt(
        nt("search", null == (t = o.className) ? void 0 : t.search),
      ),
    },
    w("input", {
      type: "search",
      ...
      onInput: p,
      className: nt(tt("input"), tt("search", "input")),
...
function Ft() {
  ...
  vt(function () {
    return (
      (v.current = e
        ? new Mt({ limit: p, page: y, url: e.url, body: e.body })
        : new Dt({ limit: p, page: y })),
      v.current instanceof Mt
        ? t.pipeline.on("afterProcess", function (t) {
            return N(t.length);
          })
        : v.current instanceof Dt &&
  ...
  return w(
    "div",
    { className: nt(tt("pagination"), t.className.pagination) },
    w(
      k,
      null,
      o &&
        ...
        w(
          "div",
          {
            role: "status",
            "aria-live": "polite",
            className: nt(tt("summary"), t.className.paginationSummary),
            ...
            E() > n &&
              ...
              w(
                ...
                w(
                  ...
                  {
                    tabIndex: -1,
                    className: nt(tt("spread"), t.className.paginationButton),
                  },
                  "...",
                ),
              ),
...
(exports.PluginPosition = void 0),
  ((Bt = exports.PluginPosition || (exports.PluginPosition = {}))[
    (Bt.Header = 0)
  ] = "Header"),
  (Bt[(Bt.Footer = 1)] = "Footer"),
  (Bt[(Bt.Cell = 2)] = "Cell");
var zt = /*#__PURE__*/ (function () {
  ...
  return (
    ...
    (n.add = function (t) {
      return t.id
        ? this.get(t.id)
          ? (qt.error("Duplicate plugin ID: " + t.id), this)
          : (this.plugins.push(t), this)
        : (qt.error("Plugin ID cannot be empty"), this);
    }),
    (n.remove = function (t) {
      var n = this.get(t);
...
function Vt(t) {
  ...
  if (t.pluginId) {
    ...
    return o ? w(k, {}, w(o.component, e({ plugin: o }, t.props))) : null;
  }
...
var $t = /*#__PURE__*/ (function (t) {
    ...
    return (
      (i.adjustWidth = function (t, n, r) {
        ...
        n.current &&
          u &&
          (B(w(Ut, { tableRef: n.current }), r.current),
          (l = (function (t) {
            var n = t.querySelector("table");
            if (!n) return {};
            var r = n.className,
              o = n.style.cssText;
            (n.className = r + " " + tt("shadowTable")),
        ...
        for (
          ...
          (p.columns && p.columns.length > 0) ||
            (!p.width && u
              ? p.id in l &&
                ((p.width = Ot(l[p.id].width)),
                (p.minWidth = Ot(l[p.id].minWidth)))
              : (p.width = Ot(Rt(p.width, a))));
        }
        return n.current && u && B(null, r.current), this;
      }),
  ...
  Zt = /*#__PURE__*/ (function () {
    ...
    return (
      (t.createFromConfig = function (t) {
        var n = null;
        return (
          t.data && (n = new Kt(t.data)),
          t.from &&
            ((n = new Kt(this.tableElementToArray(t.from))),
            (t.from.style.display = "none")),
          t.server && (n = new Xt(t.server)),
          n || qt.error("Could not determine the storage type", !0),
          n
        );
      }),
...
function Qt(t, n, e) {
  if (!t.s) {
    if (e instanceof Yt) {
      if (!e.s) return void (e.o = Qt.bind(null, t, n));
      1 & n && (n = e.s), (e = e.v);
    }
    if (e && e.then)
      return void e.then(Qt.bind(null, t, n), Qt.bind(null, t, 2));
    (t.s = n), (t.v = e);
    var r = t.o;
    r && r(t);
  }
    ...
    (t.prototype.then = function (n, e) {
      ...
      return (
        (this.o = function (t) {
          try {
            var o = t.v;
            1 & t.s ? Qt(r, 1, n ? n(o) : o) : e ? Qt(r, 1, e(o)) : Qt(r, 2, o);
          } catch (t) {
            Qt(r, 2, t);
          }
        }),
        ...
        try {
          var n = function (t) {
            ...
            u = (function (t, n) {
              ...
              throw (qt.error(t), e.emit("error", i), t);
            });
  ...
  un = /*#__PURE__*/ (function (t) {
    ...
    return (
      (o.castData = function (t) {
        ...
        var n = $t.leafColumns(this.props.header.columns);
  ...
  sn = /*#__PURE__*/ (function () {
    ...
    return (
      (t.createFromConfig = function (t) {
        var n = new nn();
        return (
          t.storage instanceof Xt &&
            n.register(new on({ serverStorageOptions: t.server })),
          n.register(new en({ storage: t.storage })),
          n.register(new un({ header: t.header })),
          n.register(new rn()),
          n
        );
      }),
        ...
        return (
          this.getChildContext ||
            ...
            (this.shouldComponentUpdate = function (t) {
              this.props.value !== t.value && e.some(C);
            }),
            (this.sub = function (t) {
              e.push(t);
  ...
  cn = /*#__PURE__*/ (function () {
    ...
    return (
      ...
      (t.defaultConfig = function () {
        return {
          store: new an({ status: a.Init, header: void 0, data: null }),
          plugin: new zt(),
      ...
      (t.fromPartialConfig = function (n) {
        ...
        return (
          ...
          e.assign({ header: $t.createFromConfig(e) }),
          e.assign({ storage: Zt.createFromConfig(e) }),
          e.assign({ pipeline: sn.createFromConfig(e) }),
          e.assign({ translator: new It(e.language) }),
          e.search &&
            e.plugin.add({
              id: "search",
    ...
    e(
      {
        ...
        className: nt(tt("td"), t.className, r.className.td),
...
function pn(t) {
  ...
  return w(
    "tr",
    {
      className: nt(tt("tr"), n.className.tr),
      onClick: function (e) {
    ...
    t.children
      ...
      : t.row.cells.map(function (n, r) {
          ...
          return o && o.hidden
            ? null
            : w(fn, { key: n.id, cell: n, row: t.row, column: o });
        }),
  );
}
function dn(t) {
  return w(
    ...
    w(fn, {
      ...
      colSpan: t.colSpan,
      messageCell: !0,
      cell: new K(t.message),
      className: nt(tt("message"), t.className ? t.className : null),
    }),
  );
}
function hn() {
  ...
  return w(
    "tbody",
    { className: nt(tt("tbody"), t.className.tbody) },
    n &&
      n.rows.map(function (t) {
        return w(pn, { key: t.id, row: t });
      }),
    e === a.Loading &&
      (!n || 0 === n.length) &&
      w(dn, {
        message: o("loading"),
        colSpan: i(),
        className: nt(tt("loading"), t.className.loading),
      }),
    e === a.Rendered &&
      n &&
      0 === n.length &&
      w(dn, {
        ...
        colSpan: i(),
        className: nt(tt("notfound"), t.className.notfound),
      }),
    e === a.Error &&
      w(dn, {
        message: o("error"),
        colSpan: i(),
        className: nt(tt("error"), t.className.error),
      }),
  );
}
      ...
      (o.validateProps = function () {
        for (var t, n = s(this.props.columns); !(t = n()).done; ) {
          ...
          void 0 === e.direction && (e.direction = 1),
            1 !== e.direction &&
              -1 !== e.direction &&
              qt.error("Invalid sort direction " + e.direction);
        }
      }),
  ...
  vn = function (t, n, r) {
    return function (o) {
      ...
      return e(
        {},
        o,
        i ? mn(t, 1 === i.direction ? -1 : 1, n, r)(o) : mn(t, 1, n, r)(o),
      );
    };
  },
  gn = /*#__PURE__*/ (function (t) {
    function o() {
      return t.apply(this, arguments) || this;
    }
    return (
...
function yn(t) {
  ...
  var d = function () {
    var t = G.Sort;
    return (
      p && "object" == typeof p.server && (t = G.ServerSort),
      0 === n.pipeline.getStepsByType(t).length
        ? t === G.ServerSort
          ? new gn(e({ columns: c ? c.columns : [] }, p.server))
          : new _n({ columns: c ? c.columns : [] })
        : null
    );
  };
  return w("button", {
    ...
    onClick: function (n) {
      n.preventDefault(),
        n.stopPropagation(),
        f(vn(t.index, !0 === n.shiftKey && p.multiColumn, t.compare));
    },
  });
}
function bn(t) {
  ...
  return w("div", {
    className: nt(tt("th"), tt("resizable")),
    onMouseDown: r,
    onTouchStart: r,
    onClick: function (t) {
    ...
    e(
      {
        ...
        className: nt(
          tt("th"),
          l() ? tt("th", "sort") : null,
          n.fixedHeader ? tt("th", "fixed") : null,
          n.className.th,
        ),
        onClick: c,
        style: e(
    ...
    w(
      ...
      void 0 !== t.column.name
        ...
        : void 0 !== t.column.plugin
          ? w(Vt, { pluginId: t.column.plugin.id, props: { column: t.column } })
          : null,
    ),
    l() && w(yn, e({ index: t.index }, t.column.sort)),
    t.column.resizable &&
      t.index < n.header.visibleColumns.length - 1 &&
      w(bn, { column: t.column, thRef: r }),
  );
}
function xn() {
  var t,
  ...
  return e
    ? w(
        "thead",
        { key: e.id, className: nt(tt("thead"), n.className.thead) },
        (t = $t.tabularFormat(e.columns)).map(function (n, r) {
          return (function (t, n, r) {
            var o = $t.leafColumns(e.columns);
            return w(
              pn,
              null,
              t.map(function (t) {
  ...
  return (
    ...
    w(
      "table",
      {
        ref: n,
        role: "grid",
        className: nt(tt("table"), t.className.table),
  ...
  return (
    ...
    n
      ? w(
          ...
          {
            ref: o,
            className: nt(tt("head"), i.className.header),
            style: e({}, i.style.header),
          },
          w(Vt, { position: exports.PluginPosition.Header }),
        )
      : null
  );
}
  ...
  return (
    ...
    r
      ? w(
          ...
          {
            ref: t,
            className: nt(tt("footer"), i.className.footer),
            style: e({}, i.style.footer),
          },
          w(Vt, { position: exports.PluginPosition.Footer }),
        )
      : null
  );
}
    ...
    vt(
      function () {
        t.header &&
          ...
          null != o &&
          o.length &&
          n(kn(t.header.adjustWidth(t, i, u)));
      },
      [o, t, u],
    );
  var s = function () {
  ...
  return w(
    "div",
    {
      ...
      className: nt(
        "gridjs",
        tt("container"),
        r === a.Loading ? tt("loading") : null,
        t.className.container,
      ),
      style: e({}, t.style.container, { width: t.width }),
    },
    r === a.Loading && w("div", { className: tt("loading-bar") }),
    w(Nn, null),
    w(
      "div",
      { className: tt("wrapper"), style: { height: t.height } },
      w(Sn, null),
    ),
    w(Pn, null),
    w("div", { ref: u, id: "gridjs-temp", className: tt("temp") }),
  );
}
var En = /*#__PURE__*/ (function (t) {
  ...
  return (
    ...
    (e.createElement = function () {
      return w(ln.Provider, { value: this.config, children: w(Cn, {}) });
    }),
    ...
    (e.destroy = function () {
      this.config.pipeline.clearCache(), B(null, this.config.container);
    }),
    (e.render = function (t) {
      return (
        t || qt.error("Container element cannot be null", !0),
...
(exports.Cell = K),
  ...
  (exports.h = w),
  (exports.html = $),
  (exports.useConfig = Ct),
  (exports.useEffect = vt),
  (exports.useRef = gt),
  (exports.useSelector = Ht),
  (exports.useState = mt),
  (exports.useStore = At),
