var e =
  ...
  t = function (e, i, r, n, a, s, l, o, c, u) {
    (this.numeralDecimalMark = e || "."),
      (this.numeralIntegerScale = i > 0 ? i : 0),
      (this.numeralDecimalScale = r >= 0 ? r : 2),
      (this.numeralThousandsGroupStyle = n || t.groupStyle.thousand),
      (this.numeralPositiveOnly = !!a),
      (this.stripLeadingZeroes = !1 !== s),
      (this.prefix = l || "" === l ? l : ""),
      (this.signBeforePrefix = !!o),
      (this.tailPrefix = !!c),
    ...
    format: function (e) {
      ...
      switch (
        ...
        e.indexOf(this.numeralDecimalMark) >= 0 &&
          ((a = (i = e.split(this.numeralDecimalMark))[0]),
          (s =
            this.numeralDecimalMark + i[1].slice(0, this.numeralDecimalScale))),
        "-" === r && (a = a.slice(1)),
      ...
      return this.tailPrefix
        ? r +
            ...
            this.prefix
        : n + a.toString() + (this.numeralDecimalScale > 0 ? s.toString() : "");
    },
  });
var i = t,
  r = function (e, t, i) {
...
r.prototype = {
  ...
  getISOFormatDate: function () {
    var e = this.date;
    return e[2]
      ? e[2] + "-" + this.addLeadingZero(e[1]) + "-" + this.addLeadingZero(e[0])
      : "";
  },
  getBlocks: function () {
    return this.blocks;
  ...
  getRangeFixedDate: function (e) {
    var t = this.datePattern,
      i = this.dateMin || [],
      r = this.dateMax || [];
    return !e.length || (i.length < 3 && r.length < 3)
      ? e
      : t.find(function (e) {
  ...
  getFixedDate: function (e, t, i) {
    return (
      ...
      (i = parseInt(i || 0, 10)),
      ((t < 7 && t % 2 == 0) || (t > 8 && t % 2 == 1)) &&
        (e = Math.min(e, 2 === t ? (this.isLeapYear(i) ? 29 : 28) : 30)),
      [e, t, i]
    );
  },
      ...
      t.blocks.forEach(function (n, a) {
        if (e.length > 0) {
          ...
          switch (t.timePattern[a]) {
            case "h":
              parseInt(l, 10) > r.maxHourFirstDigit
                ? (s = "0" + l)
                : parseInt(s, 10) > r.maxHours && (s = r.maxHours + "");
              break;
            case "m":
            case "s":
              parseInt(l, 10) > r.maxMinutesFirstDigit
                ? (s = "0" + l)
                : parseInt(s, 10) > r.maxMinutes && (s = r.maxMinutes + "");
          }
          (i += s), (e = o);
        }
      }),
...
var o = l,
  ...
  d = {
    ...
    getPositionOffset: function (e, t, i, r, n) {
      ...
      return (
        ...
        0 !== (l = a.length - s.length) ? l / Math.abs(l) : 0
      );
    },
  ...
  h = {
    assign: function (t, i) {
      return (
        (i = i || {}),
        ((t = t || {}).creditCard = !!i.creditCard),
        (t.creditCardStrictMode = !!i.creditCardStrictMode),
        (t.creditCardType = ""),
        (t.onCreditCardTypeChanged =
          i.onCreditCardTypeChanged || function () {}),
        (t.phone = !!i.phone),
        (t.phoneRegionCode = i.phoneRegionCode || "AU"),
        (t.phoneFormatter = {}),
        (t.time = !!i.time),
        (t.timePattern = i.timePattern || ["h", "m", "s"]),
        (t.timeFormat = i.timeFormat || "24"),
        (t.timeFormatter = {}),
        (t.date = !!i.date),
        (t.datePattern = i.datePattern || ["d", "m", "Y"]),
        (t.dateMin = i.dateMin || ""),
        (t.dateMax = i.dateMax || ""),
        (t.dateFormatter = {}),
        (t.numeral = !!i.numeral),
        ...
        (t.numeralDecimalMark = i.numeralDecimalMark || "."),
        (t.numeralThousandsGroupStyle =
          i.numeralThousandsGroupStyle || "thousand"),
        (t.numeralPositiveOnly = !!i.numeralPositiveOnly),
        (t.stripLeadingZeroes = !1 !== i.stripLeadingZeroes),
        (t.signBeforePrefix = !!i.signBeforePrefix),
        (t.tailPrefix = !!i.tailPrefix),
        (t.swapHiddenInput = !!i.swapHiddenInput),
        (t.numericOnly = t.creditCard || t.date || !!i.numericOnly),
        (t.uppercase = !!i.uppercase),
        (t.lowercase = !!i.lowercase),
        (t.prefix = t.creditCard || t.date ? "" : i.prefix || ""),
        (t.noImmediatePrefix = !!i.noImmediatePrefix),
        (t.prefixLength = t.prefix.length),
        (t.rawValueTrimPrefix = !!i.rawValueTrimPrefix),
        (t.copyDelimiter = !!i.copyDelimiter),
        (t.initValue =
        ...
        (t.delimiterLazyShow = !!i.delimiterLazyShow),
        (t.delimiters = i.delimiters || []),
        (t.blocks = i.blocks || []),
        (t.blocksLength = t.blocks.length),
        (t.root = "object" == typeof e && e ? e : window),
        (t.document = i.document || t.root.document),
        (t.maxLength = 0),
        (t.backspace = !1),
        (t.result = ""),
        (t.onValueChanged = i.onValueChanged || function () {}),
        t
      );
    },
  },
  m = function (e, t) {
    ...
    (t.initValue = this.element.value),
      (this.properties = m.DefaultProperties.assign({}, t)),
      this.init();
  };
(m.prototype = {
  init: function () {
    ...
    0 !== e.blocksLength ||
    e.prefix
      ? ((e.maxLength = m.Util.getMaxLength(e.blocks)),
        (this.isAndroid = m.Util.isAndroid()),
        (this.lastInputValue = ""),
        (this.isBackward = ""),
  ...
  initNumeralFormatter: function () {
    var e = this.properties;
    e.numeral &&
      (e.numeralFormatter = new m.NumeralFormatter(
  ...
  initTimeFormatter: function () {
    var e = this.properties;
    e.time &&
      ((e.timeFormatter = new m.TimeFormatter(e.timePattern, e.timeFormat)),
  ...
  initDateFormatter: function () {
    var e = this.properties;
    e.date &&
      ((e.dateFormatter = new m.DateFormatter(
        e.datePattern,
        e.dateMin,
        e.dateMax,
      )),
  ...
  initPhoneFormatter: function () {
    ...
    if (e.phone)
      try {
        e.phoneFormatter = new m.PhoneFormatter(
  ...
  onFocus: function () {
    ...
    (this.lastInputValue = this.element.value),
      ...
      m.Util.fixPrefixCursor(this.element, e.prefix, e.delimiter, e.delimiters);
  },
  onCut: function (e) {
    m.Util.checkFullSelection(this.element.value) &&
    ...
    return (
      ...
      t.phone
        ? (!t.prefix || (t.noImmediatePrefix && !e.length)
            ...
            : (t.result =
                t.prefix + t.phoneFormatter.format(e).slice(t.prefix.length)),
  ...
  updateCreditCardPropsByValue: function (e) {
    ...
    r.headStr(i.result, 4) !== r.headStr(e, 4) &&
      ((t = m.CreditCardDetector.getInfo(e, i.creditCardStrictMode)),
      (i.blocks = t.blocks),
  ...
  updateValueState: function () {
    ...
    if (e.element) {
      var r = e.element.selectionEnd,
        n = e.element.value,
        a = i.result;
      (r = t.getNextCursorPosition(r, n, a, i.delimiter, i.delimiters)),
        e.isAndroid
          ? window.setTimeout(function () {
              (e.element.value = a),
                t.setSelection(e.element, r, i.document, !1),
                e.callOnValueChanged();
            }, 1)
          : ((e.element.value = a),
            i.swapHiddenInput && (e.elementSwapHidden.value = e.getRawValue()),
            t.setSelection(e.element, r, i.document, !1),
            e.callOnValueChanged());
    }
  },
  ...
  (m.NumeralFormatter = i),
  (m.DateFormatter = n),
  (m.TimeFormatter = s),
  (m.PhoneFormatter = o),
  (m.CreditCardDetector = u),
  (m.Util = d),
  (m.DefaultProperties = h),
  (("object" == typeof e && e ? e : window).Cleave = m);
export default m;
