  ...
  "object" == typeof exports && "object" == typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : "object" == typeof exports
        ? (exports.Cleave = t(require("react")))
        : (e.Cleave = t(e.React));
})(this, function (e) {
  return (function (e) {
    function t(r) {
        ...
        f = a({
          ...
          componentDidUpdate: function (e) {
            var t = this,
              ...
              r = t.props.value,
              i = t.properties;
            t.updateRegisteredEvents(t.props),
              e.value !== r &&
                void 0 !== r &&
                null !== r &&
                ((r = r.toString()),
                r !== t.properties.result &&
                  ((t.properties.initValue = r), t.onInput(r, !0)));
            var o = (e.options || {}).phoneRegionCode;
            o !== n &&
              n &&
              n !== t.properties.phoneRegionCode &&
              ((t.properties.phoneRegionCode = n),
              t.initPhoneFormatter(),
              t.onInput(t.properties.result)),
              d.setSelection(t.element, t.state.cursorPosition, i.document);
          },
          updateRegisteredEvents: function (e) {
            ...
            e.onInit &&
              e.onInit !== s &&
              (t.registeredEvents.onInit = e.onInit),
              e.onChange &&
                e.onChange !== i &&
                (t.registeredEvents.onChange = e.onChange),
              e.onFocus &&
                e.onFocus !== o &&
                (t.registeredEvents.onFocus = e.onFocus),
              e.onBlur &&
                e.onBlur !== a &&
                (t.registeredEvents.onBlur = e.onBlur),
              e.onKeyDown &&
                e.onKeyDown !== r &&
                (t.registeredEvents.onKeyDown = e.onKeyDown);
          },
          ...
          init: function () {
            ...
            return t.numeral ||
              ...
              0 !== t.blocksLength ||
              t.prefix
              ? ((t.maxLength = d.getMaxLength(t.blocks)),
                (e.isAndroid = d.isAndroid()),
                ...
                void e.registeredEvents.onInit(e))
          ...
          initTimeFormatter: function () {
            var e = this,
              t = e.properties;
            t.time &&
              ((t.timeFormatter = new l(t.timePattern, t.timeFormat)),
          ...
          initDateFormatter: function () {
            var e = this,
              t = e.properties;
            t.date &&
              ((t.dateFormatter = new c(t.datePattern, t.dateMin, t.dateMax)),
            ...
            return (
              ...
              (n = t.numeral
                ? t.numeralFormatter
                  ...
                  : ""
                : d.stripDelimiters(n, t.delimiter, t.delimiters))
            );
          },
          ...
          onFocus: function (e) {
            ...
            n.prefix &&
              ...
              (e.target.value = n.result),
              t.registeredEvents.onFocus(e),
              d.fixPrefixCursor(t.element, n.prefix, n.delimiter, n.delimiters);
          },
          onBlur: function (e) {
            var t = this,
              n = t.properties;
          ...
          onInput: function (e, t) {
            var n = this,
              r = n.properties,
              i = d.getPostDelimiter(e, r.delimiter, r.delimiters);
            return (
              t ||
                r.numeral ||
                !r.postDelimiterBackspace ||
                i ||
                (e = d.headStr(e, e.length - r.postDelimiterBackspace.length)),
              r.phone
                ...
                : r.numeral
                  ...
                  : (r.date && (e = r.dateFormatter.getValidatedDate(e)),
                    ...
                    (e = d.stripDelimiters(e, r.delimiter, r.delimiters)),
                    (e = d.getPrefixStrippedValue(
                      e,
                      r.prefix,
                      r.prefixLength,
                      r.result,
                    ...
                    (e = r.numericOnly ? d.strip(e, /[^\d]/g) : e),
                    (e = r.uppercase ? e.toUpperCase() : e),
                    (e = r.lowercase ? e.toLowerCase() : e),
                    r.prefix &&
                    (r.tailPrefix ? (e += r.prefix) : (e = r.prefix + e),
                    0 === r.blocksLength)
                      ? ((r.result = e), void n.updateValueState())
                      : (r.creditCard && n.updateCreditCardPropsByValue(e),
                        (e = r.maxLength > 0 ? d.headStr(e, r.maxLength) : e),
                        (r.result = d.getFormattedValue(
                          e,
                          r.blocks,
                          r.blocksLength,
                          r.delimiter,
          ...
          updateCreditCardPropsByValue: function (e) {
            var t,
              n = this,
              r = n.properties;
            d.headStr(r.result, 4) !== d.headStr(e, 4) &&
              ((t = p.getInfo(e, r.creditCardStrictMode)),
              (r.blocks = t.blocks),
              (r.blocksLength = r.blocks.length),
              (r.maxLength = d.getMaxLength(r.blocks)),
              r.creditCardType !== t.type &&
                ((r.creditCardType = t.type),
                r.onCreditCardTypeChanged.call(n, r.creditCardType)));
          },
          updateValueState: function () {
            var e = this,
              t = e.properties;
            if (!e.element) return void e.setState({ value: t.result });
            var n = e.element.selectionEnd,
              r = e.element.value,
              i = t.result;
            return (
              (e.lastInputValue = i),
              (n = d.getNextCursorPosition(n, r, i, t.delimiter, t.delimiters)),
              e.isAndroid
                ? void window.setTimeout(function () {
                    e.setState({ value: i, cursorPosition: n });
                  }, 1)
                : void e.setState({ value: i, cursorPosition: n })
            );
          },
          render: function () {
            var e = this,
      ...
      function i(e, t, n) {
        ...
        function d(e, n) {
          if (n) {
            ...
            n.hasOwnProperty(u) && I.mixins(e, n.mixins);
            for (var o in n)
              if (n.hasOwnProperty(o) && o !== u) {
                var a = n[o],
                  l = r.hasOwnProperty(o);
                if ((p(l, o), I.hasOwnProperty(o))) I[o](e, a);
                else {
                  var d = D.hasOwnProperty(o),
                    m = "function" == typeof a,
                    f = m && !d && !l && n.autobind !== !1;
                  if (f) i.push(o, a), (r[o] = a);
                  else if (l) {
                    var v = D[o];
                    s(
        ...
        function v(e, t) {
          ...
          if ("production" !== process.env.NODE_ENV) {
            ...
            n.bind = function (o) {
              for (
                var a = arguments.length, s = Array(a > 1 ? a - 1 : 0), l = 1;
                l < a;
                l++
              )
                s[l - 1] = arguments[l];
        ...
        function x(e) {
          ...
          (t.prototype = new P()),
            ...
            "production" !== process.env.NODE_ENV &&
              ...
              c(
                !t.prototype.UNSAFE_componentWillRecieveProps,
                "%s has a method called UNSAFE_componentWillRecieveProps(). Did you mean UNSAFE_componentWillReceiveProps()?",
                e.displayName || "A component",
              ));
          for (var i in D) t.prototype[i] || (t.prototype[i] = null);
          return t;
        }
        var E = [],
          D = {
          ...
          I = {
            ...
            childContextTypes: function (e, t) {
              "production" !== process.env.NODE_ENV && i(e, t, "childContext"),
                (e.childContextTypes = o({}, e.childContextTypes, t));
            },
            contextTypes: function (e, t) {
              "production" !== process.env.NODE_ENV && i(e, t, "context"),
            ...
            propTypes: function (e, t) {
              "production" !== process.env.NODE_ENV && i(e, t, "prop"),
          ...
          P = function () {};
        return o(P.prototype, e.prototype, F), x;
      }
      var o = n(4),
        a = n(5),
        s = n(6);
      if ("production" !== process.env.NODE_ENV) var c = n(7);
      var l,
        u = "mixins";
      (l =
        "production" !== process.env.NODE_ENV
    ...
    function (e, t) {
      ...
      e.exports = r()
        ? Object.assign
        : function (e, t) {
            for (var r, s, c = n(e), l = 1; l < arguments.length; l++) {
              r = Object(arguments[l]);
              for (var u in r) o.call(r, u) && (c[u] = r[u]);
              if (i) {
                s = i(r);
    ...
    function (e, t) {
      "use strict";
      var n = {};
      "production" !== process.env.NODE_ENV && Object.freeze(n),
        (e.exports = n);
    },
    function (e, t) {
      "use strict";
    ...
    function (e, t) {
      "use strict";
      var n = function r(e, t, n, i, o, a, s, c, l, u) {
        var p = this;
        (p.numeralDecimalMark = e || "."),
          (p.numeralIntegerScale = t > 0 ? t : 0),
          (p.numeralDecimalScale = n >= 0 ? n : 2),
          (p.numeralThousandsGroupStyle = i || r.groupStyle.thousand),
          (p.numeralPositiveOnly = !!o),
          (p.stripLeadingZeroes = a !== !1),
          (p.prefix = s || "" === s ? s : ""),
          (p.signBeforePrefix = !!c),
          (p.tailPrefix = !!l),
          (p.delimiter = u || "" === u ? u : ","),
          (p.delimiterRE = u ? new RegExp("\\" + u, "g") : "");
      };
      (n.groupStyle = {
        thousand: "thousand",
        lakh: "lakh",
          ...
          format: function (e) {
            ...
            switch (
              ...
              e.indexOf(a.numeralDecimalMark) >= 0 &&
                ((t = e.split(a.numeralDecimalMark)),
                (o = t[0]),
                (s =
                  a.numeralDecimalMark + t[1].slice(0, a.numeralDecimalScale))),
              "-" === r && (o = o.slice(1)),
            ...
            return a.tailPrefix
              ? r +
                  o.toString() +
                  (a.numeralDecimalScale > 0 ? s.toString() : "") +
                  a.prefix
              : i +
                  o.toString() +
                  (a.numeralDecimalScale > 0 ? s.toString() : "");
      ...
      (n.prototype = {
        ...
        getFixedDateString: function (e) {
          ...
          4 === e.length &&
            ...
            8 === e.length &&
              ...
              (t = parseInt(e.slice(u, u + 2), 10)),
              (n = parseInt(e.slice(p, p + 2), 10)),
              (r = parseInt(e.slice(d, d + 4), 10)),
              (m = 4 === e.slice(d, d + 4).length),
              (a = this.getFixedDate(t, n, r))),
            4 !== e.length ||
              ("y" !== o[0] && "y" !== o[1]) ||
              ((p = "m" === o[0] ? 0 : 2),
              (d = 2 - p),
            ...
            0 === a.length
              ...
              : o.reduce(function (e, t) {
                  switch (t) {
                    ...
                    case "y":
                      return e + (m ? i.addLeadingZeroForYear(a[2], !1) : "");
                    case "Y":
                      return e + (m ? i.addLeadingZeroForYear(a[2], !0) : "");
                  }
                }, "");
          return f;
        },
        getRangeFixedDate: function (e) {
          var t = this,
            ...
            r = t.dateMin || [],
            i = t.dateMax || [];
          return !e.length || (r.length < 3 && i.length < 3)
            ? e
            : n.find(function (e) {
            ...
            t.blocks.forEach(function (i, o) {
              if (e.length > 0) {
                ...
                switch (t.timePattern[o]) {
                  case "h":
                    parseInt(s, 10) > r.maxHourFirstDigit
                      ? (a = "0" + s)
                      : parseInt(a, 10) > r.maxHours && (a = r.maxHours + "");
                    break;
                  case "m":
                  case "s":
                    parseInt(s, 10) > r.maxMinutesFirstDigit
                      ? (a = "0" + s)
    ...
    function (e, t) {
      ...
      (n.prototype = {
        ...
        format: function (e) {
          ...
          for (var n, r = "", i = !1, o = 0, a = e.length; o < a; o++)
            (n = t.formatter.inputDigit(e.charAt(o))),
              /[\s()-]/g.test(n) ? ((r = n), (i = !0)) : i || (r = n);
          return (
            (r = r.replace(/[()]/g, "")), (r = r.replace(/[\s-]/g, t.delimiter))
          );
        },
      }),
        (e.exports = n);
      ...
      var n = {
        ...
        getInfo: function (e, t) {
          ...
          for (var o in i)
            if (i[o].test(e)) {
              var a = r[o];
              return { type: o, blocks: t ? this.getStrictBlocks(a) : a };
            }
          return {
            type: "unknown",
    ...
    function (e, t) {
      ...
      var n = {
        ...
        getNextCursorPosition: function (e, t, n, r, i) {
          return t.length === e
            ? n.length
            : e + this.getPositionOffset(e, t, n, r, i);
        },
        getPositionOffset: function (e, t, n, r, i) {
          var o, a, s;
          return (
            (o = this.stripDelimiters(t.slice(0, e), r, i)),
            (a = this.stripDelimiters(n.slice(0, e), r, i)),
            (s = o.length - a.length),
            0 !== s ? s / Math.abs(s) : 0
          );
        },
        ...
        getPrefixStrippedValue: function (e, t, n, r, i, o, a, s, c) {
          if (0 === n) return e;
          if (e === t && "" !== e) return "";
          if (c && "-" == e.slice(0, 1)) {
            ...
            return (
              "-" +
              this.getPrefixStrippedValue(e.slice(1), t, n, l, i, o, a, s, c)
            );
          }
        ...
        r = {
          assign: function (e, t) {
            return (
              ...
              (e.root =
                "object" ===
                  ("undefined" == typeof global ? "undefined" : n(global)) &&
                global
                  ? global
                  : window),
