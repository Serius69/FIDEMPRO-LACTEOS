  ...
  return (function (e) {
        ...
        f = a({
          ...
          initTimeFormatter: function () {
            var e = this,
              t = e.properties;
            t.time &&
              ((t.timeFormatter = new u(t.timePattern, t.timeFormat)),
        ...
        function i(e, n, i) {
          ...
          function m(e, r) {
            if (r) {
              ...
              r.hasOwnProperty(l) && I.mixins(e, r.mixins);
              for (var a in r)
                if (r.hasOwnProperty(a) && a !== l) {
                  var u = r[a],
                    p = i.hasOwnProperty(a);
                  if ((d(p, a), I.hasOwnProperty(a))) I[a](e, u);
                  else {
                    var m = w.hasOwnProperty(a),
                      f = "function" == typeof u,
                      h = f && !m && !p && r.autobind !== !1;
                    if (h) o.push(a, u), (i[a] = u);
                    else if (p) {
                      var y = w[a];
                      s(
                        m &&
          ...
          function x(e) {
            var n = r(function (e, r, o) {
              "production" !== t.env.NODE_ENV &&
                ...
                this.__reactAutoBindPairs.length && E(this),
                (this.props = e),
                (this.context = r),
                (this.refs = a),
                (this.updater = o || i),
            ...
            (n.prototype = new S()),
              ...
              "production" !== t.env.NODE_ENV &&
                ...
                c(
                  !n.prototype.UNSAFE_componentWillRecieveProps,
          ...
          var D = [],
            ...
            S = function () {};
          return o(S.prototype, e.prototype, P), x;
        }
        var o = n(5),
          a = n(6),
          s = n(7);
        if ("production" !== t.env.NODE_ENV) var c = n(8);
        var u,
          l = "mixins";
        (u =
          "production" !== t.env.NODE_ENV
    ...
    function (e, t) {
      ...
      function a() {
        h &&
          m &&
          ((h = !1), m.length ? (f = m.concat(f)) : (g = -1), f.length && s());
      }
      function s() {
        if (!h) {
          var e = i(a);
      ...
      (d.nextTick = function (e) {
        ...
        f.push(new c(e, t)), 1 !== f.length || h || i(s);
      }),
    ...
    function (e, t) {
      "use strict";
      var n = function r(e, t, n, i, o, a, s, c, u, l) {
        var p = this;
        (p.numeralDecimalMark = e || "."),
          ...
          (p.tailPrefix = !!u),
          (p.delimiter = l || "" === l ? l : ","),
          (p.delimiterRE = l ? new RegExp("\\" + l, "g") : "");
      };
      (n.groupStyle = {
        thousand: "thousand",
        lakh: "lakh",
      ...
      var n = {
        ...
        getPrefixStrippedValue: function (e, t, n, r, i, o, a, s, c) {
          ...
          if (c && "-" == e.slice(0, 1)) {
            ...
            return (
              "-" +
              this.getPrefixStrippedValue(e.slice(1), t, n, u, i, o, a, s, c)
            );
          }
          if (r.slice(0, n) !== t && !s) return a && !r && e ? e : "";
          if (r.slice(-n) !== t && s) return a && !r && e ? e : "";
          var l = this.stripDelimiters(r, i, o);
