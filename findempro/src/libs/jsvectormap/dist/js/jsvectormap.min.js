!(function (t, e) {
  ...
  function y(t, e, i) {
    ...
    return (
      i && (r = a + ".tooltip:show"),
      {
        ...
        tooltipText:
          "region" === a
            ? t.mapData.paths[n].name || ""
            : t.markers[n].config.name || "",
      }
    );
  }
  function b(t, e) {
  ...
  var x = (function () {
      ...
      return (
        (t.prototype.dispose = function () {
          ...
          for (
            var t, e = k(Object.getOwnPropertyNames(this));
            !(t = e()).done;
          ...
          for (var o = 0; o < a.length; o++) {
            switch (
              ...
              case "fill":
                (s = a[o].value),
                  /\.(jpg|gif|png)$/.test(s)
                    ? (e.style.background = "url(" + a[o].value + ")")
    ...
    X = (function () {
      function t(t, e, i) {
        void 0 === t && (t = {}),
          ...
          "object" == typeof t.scale && (this.scale = new A(t.scale)),
          this.config.legend &&
            (this.legend = new O(
              u({ map: this._map, series: this }, this.config.legend),
            )),
  ...
  var E = {
      ...
      _setupElementEvents: function () {
        ...
        g.on(a, "mousemove", function (s) {
          ...
          g.delegate(a, "mouseover mouseout", ".jvm-element", function (t) {
            ...
            "mouseover" === t.type
              ? (e.element.hover(!0),
                s.tooltip.text(e.tooltipText),
                s._emit(e.event, [t, s.tooltip, e.code]),
                t.defaultPrevented || (i && s.tooltip.show()))
              : (e.element.hover(!1), i && s.tooltip.hide());
          }),
      ...
      _createRegions: function () {
        var t, e;
        for (t in ((this._regionLabelsGroup =
        ...
        this.mapData.paths))
          (e = new j({
            ...
            (this.regions[t] = { config: this.mapData.paths[t], element: e });
      },
      _createLines: function (t, e, i) {
        ...
        t)) {
          ...
          !1 !== s &&
            !1 !== a &&
            (this.lines[p(r.from, r.to)] = new C({
              index: n,
              map: this,
              style: u(
      ...
      _createMarkers: function (t, e) {
        ...
        t))
          if (
            ...
            if (e) {
              if (
                Object.keys(this.markers).filter(function (t) {
            ...
            (s = new L({
              index: o,
              map: this,
              style: u(this.params.markerStyle, { initial: i.style || {} }, !0),
              ...
              (this.markers[o] = { _uid: n, config: i, element: s });
          }
      },
      ...
      _applyTransform: function () {
        ...
        this.defaultWidth * this.scale <= this.width
          ...
          this.markers && this._repositionMarkers(),
          this.lines && this._repositionLines(),
            ...
            ? ((o = this.scale),
              ...
              (r = setInterval(function () {
                (g += 1),
                  ...
                  g == y &&
                    (clearInterval(r),
                    m._emit(v.onViewportChange, [m.scale, m.transX, m.transY]));
              }, 10)))
            : ((this.transX = d),
              (this.transY = f),
              (this.scale = t),
              this._applyTransform(),
              this._emit(v.onViewportChange, [
                this.scale,
                this.transX,
                this.transY,
              ]));
      ...
      setFocus: function (t) {
        ...
        if (t.coords) {
          ...
          return this._setScale(t.scale * this.baseScale, n, r, !0, t.animate);
        }
      },
      updateSize: function () {
      ...
      coordsToPoint: function (t, e) {
        var i,
          s,
          a,
          n = V.maps[this.params.map].projection,
          r = n.centralMeridian;
        return (
          (i = Y[n.type](t, e, r)),
      ...
      _repositionLines: function () {
        ...
        for (var i in this.lines) {
          ...
          !1 !== t &&
            !1 !== e &&
            this.lines[i].setStyle({ x1: t.x, y1: t.y, x2: e.x, y2: e.y });
        }
      },
    ...
    z = (function (t) {
      ...
      return (
        (i.setStyle = function (t, e) {
          var i;
          "object" == typeof t
            ? u(this.style.current, t)
            : u(this.style.current, (((i = {})[t] = e), i));
          this.updateStyle();
        }),
    ...
    I = (function (t) {
      function e(e) {
        ...
        return (
          ...
          (i._defsElement = new T("defs")),
          (i._rootElement = new T("g", { id: "jvm-regions-group" })),
      ...
      return (
        (e._init = function () {
          ...
          (this.container = h(t.selector)),
            ...
            (this.canvas = new I(this.container)),
            ...
            t.showTooltip && (this.tooltip = new R(this)),
            t.selectedRegions &&
              this._setSelected("regions", t.selectedRegions),
            t.selectedMarkers &&
              this._setSelected("markers", t.selectedMarkers),
            t.focusOn && this.setFocus(t.focusOn),
            t.visualizeData &&
              (this.dataVisualization = new H(t.visualizeData, this)),
            t.bindTouchEvents &&
            ...
            t.series &&
              (this.container.appendChild(
                (this.legendHorizontal = l(
                  "div",
                  "jvm-series-container jvm-series-h",
                )),
              ),
              this.container.appendChild(
                (this.legendVertical = l(
                  "div",
        ...
        (e.addLine = function (t, e, i) {
          void 0 === i && (i = {}),
            ...
            this._createLines([{ from: t, to: e, style: i }], this.markers, !0);
        }),
        ...
        (e.removeLines = function (t) {
          ...
          (t = Array.isArray(t)
            ...
            e.lines[t].dispose(), delete e.lines[t];
          });
        }),
        ...
        (e.removeLine = function (t, e) {
          ...
          var i = p(t, e);
          this.lines.hasOwnProperty(i) &&
            (this.lines[i].element.remove(), delete this.lines[i]);
        }),
        (e.reset = function () {
          ...
          this.legendHorizontal &&
            (c(this.legendHorizontal), (this.legendHorizontal = null)),
            this.legendVertical &&
              (c(this.legendVertical), (this.legendVertical = null)),
