...
!(function () {
          ...
          void 0 !== n &&
            ...
            (d(e[r]) && d(i[r])
              ? i[r].__swiper__
                ...
                : p(e[r], i[r])
              : !d(e[r]) && d(i[r])
                ? ((e[r] = {}), i[r].__swiper__ ? (e[r] = i[r]) : p(e[r], i[r]))
                : (e[r] = i[r]));
        }
      }
    }
  ...
  var P = {
    ...
    updateSlides: function () {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            if (
              ...
              k = e.isHorizontal() ? g(n, "width", !0) : g(n, "height", !0);
            else {
              const e = s(a, "width"),
                t = s(a, "padding-left"),
                i = s(a, "padding-right"),
      ...
      if (
        ...
        P && e.grid.updateWrapperSize(k, v, t),
        !i.centeredSlides)
      ) {
        const t = [];
      ...
      if (
        ...
        u(r, "--swiper-centered-offset-before", -v[0] + "px"),
          u(
            r,
            "--swiper-centered-offset-after",
            e.size / 2 - A[A.length - 1] / 2 + "px",
          );
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!n.support.smoothScroll)
            return (
              h({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, r) {
      ...
      if (
        ...
        return (
          ...
          "reset" !== A && (n.transitionStart(s, A), n.transitionEnd(s, A)),
          !1
        );
      if (o.cssMode) {
        const e = n.isHorizontal(),
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              h({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  var O = {
    ...
    loopFix: function (e) {
      ...
      let S = 0,
        T = 0;
      if (n < m) {
        S = Math.max(m - n, h.slidesPerGroup);
        for (let e = 0; e < m - n; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          v.push(d.length - t - 1);
        }
      } else if (n > l.slides.length - 2 * m) {
        T = Math.max(n - (l.slides.length - 2 * m), h.slidesPerGroup);
        for (let e = 0; e < T; e += 1) {
          const t = e - Math.floor(e / d.length) * d.length;
          g.push(t);
        }
  ...
  function I(e) {
    ...
    const T = S && t.allowTouchMove && l.touchStartPreventDefault;
  ...
  function _(e) {
    ...
    if (h > r.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (A >= r.longSwipesRatio
          ? t.slideTo(r.rewind && t.isEnd ? g : m + b)
          : t.slideTo(m)),
        "prev" === t.swipeDirection &&
          (A > 1 - r.longSwipesRatio
            ? t.slideTo(m + b)
            : null !== w && A < 0 && Math.abs(A) > r.longSwipesRatio
              ? t.slideTo(w)
              : t.slideTo(m));
    } else {
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = I.bind(e)),
            ...
            (e.onClick = D.bind(e)),
            (e.onLoad = N.bind(e)),
            F || (t.addEventListener("touchstart", j), (F = !0)),
            V(e, "on");
        },
  ...
  class q {
    constructor() {
      ...
      (o.__swiper__ = !0),
        (o.support = S()),
        (o.device = T({ userAgent: t.userAgent })),
        (o.browser = y()),
        (o.eventsListeners = {}),
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = v(f(t, `.${s.slideClass}, swiper-slide`)[0]);
      return v(e) - i;
    }
  ...
  function U(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : Z(t[s]) && Z(e[s]) && Object.keys(t[s]).length > 0
            ? t[s].__swiper__
              ? (e[s] = t[s])
              : U(e[s], t[s])
            : (e[s] = t[s]);
  ...
  function te(e, t, s) {
    ...
    return (
      "string" == typeof t && void 0 !== s && o.push({ name: t, value: s }),
      o.forEach((e) => {
        const t = ee.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
        if (t) {
          const s = K(t),
            i = K(e.name.split(`${t}-`)[1]);
          void 0 === r[s] && (r[s] = {}),
            !0 === r[s] && (r[s] = { enabled: !0 }),
            (r[s][i] = J(e.value));
        } else {
          ...
          const s = J(e.value);
          r[t] && ee.includes(e.name)
            ? (r[t].constructor !== Object && (r[t] = {}), (r[t].enabled = s))
            : (r[t] = s);
        }
      }),
      U(i, r),
  ...
  const re = (e, t) => {
    ...
    !e &&
      ...
      (s && !i) ||
        ...
        (s.textContent = [se, t ? t.cssStyles() : ""].join("\n")),
  ...
  class ae extends ne {
    ...
    render() {
      ...
      e.length &&
        ...
        this.cssLinks().forEach((e) => {
          if (this.shadowEl.querySelector(`link[href="${e}"]`)) return;
          const t = document.createElement("link");
        ...
        (function (e) {
          ...
          r.includes("loop") &&
            ...
            r.includes("children") &&
              ...
              f &&
              c.virtual.enabled &&
              ((f.slides = s), f.update(!0)),
            r.includes("children") && s && c.loop && (y = !0),
            v && m.init() && m.update(!0);
    ...
    static get observedAttributes() {
      return Q.filter((e) => e.includes("_")).map((e) =>
        e
          .replace(/[A-Z]/g, (e) => `-${e}`)
          .replace("_", "")
          .toLowerCase(),
  ...
  "undefined" != typeof window &&
    ...
    "undefined" != typeof window &&
      ...
      window.customElements.get("swiper-slide") ||
        window.customElements.define("swiper-slide", oe));
})();
