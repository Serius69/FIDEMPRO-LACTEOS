    ...
    if (e.params.grid && e.params.grid.rows > 1) {
      ...
      return (
        ...
        void e.slides.forEach((t, s) => {
          r.includes(t.column) && unlazy(e, s);
        })
      );
    }
    const r = i + a - 1;
...
function Mousewheel(e) {
  ...
  function m(e) {
    ...
    if (r.forceToAxis)
      ...
      p = Math.abs(f.pixelX) > Math.abs(f.pixelY) ? -f.pixelX * m : -f.pixelY;
    if (0 === p) return !0;
    r.invert && (p = -p);
...
function Zoom(e) {
  ...
  function y(e) {
    ...
    const r = (s.scale - o) / (p.maxRatio - t.params.zoom.minRatio),
      { originX: n, originY: l } = p;
    (u.currentX =
      u.touchesCurrent.x - u.touchesStart.x + u.startX + r * (u.width - 2 * n)),
      (u.currentY =
        u.touchesCurrent.y -
        u.touchesStart.y +
        u.startY +
    ...
    1 === o && C && ((i = void 0), (n = void 0)),
      ...
      !e || (1 === o && C)
        ...
        : ((T = p.slideEl.offsetWidth),
          ...
          h < E && (h = E),
          h > x && (h = x)),
      C && 1 === s.scale && ((p.originX = 0), (p.originY = 0)),
          ...
          h() &&
            t.pagination.bullets.forEach((s) => {
              t.params.pagination.clickable &&
                ...
                s.matches(
                  classesToSelector(t.params.pagination.bulletActiveClass),
                )
  ...
  const o = () => {
    ...
    d = () => {
      ...
      l.history.replaceState
        ? (l.history.replaceState(null, null, `#${s}` || ""), a("hashSet"))
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < e.length; s += 1) {
        ...
        (E.style.transform = y),
          (E.style.opacity = b),
          h.origin && (E.style.transformOrigin = h.origin);
      }
    },
    setTransition: (e) => {
      const s = t.slides.map((e) => getSlideTransformEl(e));
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let o = 0; o < e.length; o += 1) {
        ...
        effectTarget(i, d).style.transform = x;
      }
    },
    setTransition: (e) => {
      const s = t.slides.map((e) => getSlideTransformEl(e));
