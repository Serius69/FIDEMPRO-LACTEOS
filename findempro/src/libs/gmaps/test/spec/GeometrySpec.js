describe("Drawing geometry overlays", function () {
  ...
  describe("A line", function () {
    beforeEach(function () {
      line =
        line ||
        map_with_polygons.drawPolyline({
          path: [
            [-12.044, -77.0247],
            [-12.0544, -77.0302],
            [-12.0551, -77.0303],
    ...
    it("should return the defined path", function () {
      ...
      expect(parseFloat(first_point.lat().toFixed(4))).toEqual(-12.044);
  ...
  describe("A rectangle", function () {
    beforeEach(function () {
      rectangle =
        rectangle ||
        map_with_polygons.drawRectangle({
          bounds: [
            [-12.0303, -77.0237],
            [-12.0348, -77.0115],
          ],
