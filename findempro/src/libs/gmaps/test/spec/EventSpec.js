describe("Creating event listeners", function () {
  ...
  var marker_added_event,
    marker_removed_event,
    polyline_added_event,
    polyline_removed_event,
    polygon_added_event,
    polygon_removed_event;
  ...
  describe("for google.maps events", function () {
    ...
    describe("To a map", function () {
      it("should add the listener to the listeners collection", function () {
        var click_event = GMaps.on(
          "click",
          map_events.map,
          callbacks_native.map.onclick,
        );

        expect(
          map_events.map["__e3_"]["click"][click_event["id"]],
        ).toBeDefined();
        expect(map_events.map["__e3_"]["click"][click_event["id"]]).toEqual(
          click_event,
        );
      });
    });
    ...
    describe("To a marker", function () {
      it("should add the listener to the listeners collection", function () {
        var click_event = GMaps.on(
          "click",
          marker,
          callbacks_native.marker.onclick,
        );

        expect(marker["__e3_"]["click"][click_event["id"]]).toBeDefined();
        expect(marker["__e3_"]["click"][click_event["id"]]).toEqual(
          click_event,
        );
      });
    });
    ...
    describe("To a polygon", function () {
      it("should add the listener to the listeners collection", function () {
        var click_event = GMaps.on(
          "click",
          polygon,
          callbacks_native.polygon.onclick,
        );

        expect(polygon["__e3_"]["click"][click_event["id"]]).toBeDefined();
        expect(polygon["__e3_"]["click"][click_event["id"]]).toEqual(
          click_event,
        );
      });
    });
    ...
    describe("registering non custom events", function () {
      it("custom registered_events should not exist", function () {
        ...
        expect(
          map_events.registered_events["bounds_changed"],
        ).not.toBeDefined();
      });
  ...
  describe("for GMaps events", function () {
    ...
    describe("#marker_added", function () {
      beforeEach(function () {
        marker_added_event = GMaps.on(
          "marker_added",
          map_events,
          callbacks_gmaps.marker_added,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["marker_added"][0]).toEqual(
          marker_added_event,
        );
      });
    ...
    describe("#marker_removed", function () {
      beforeEach(function () {
        marker_removed_event = GMaps.on(
          "marker_removed",
          map_events,
          callbacks_gmaps.marker_removed,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["marker_removed"][0]).toEqual(
          marker_removed_event,
        );
      });
    ...
    describe("#polyline_added", function () {
      beforeEach(function () {
        polyline_added_event = GMaps.on(
          "polyline_added",
          map_events,
          callbacks_gmaps.polyline_added,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["polyline_added"][0]).toEqual(
          polyline_added_event,
        );
      });
    ...
    describe("#polyline_removed", function () {
      beforeEach(function () {
        polyline_removed_event = GMaps.on(
          "polyline_removed",
          map_events,
          callbacks_gmaps.polyline_removed,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["polyline_removed"][0]).toEqual(
          polyline_removed_event,
        );
      });
    ...
    describe("#polygon_added", function () {
      beforeEach(function () {
        polygon_added_event = GMaps.on(
          "polygon_added",
          map_events,
          callbacks_gmaps.polygon_added,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["polygon_added"][0]).toEqual(
          polygon_added_event,
        );
      });
    ...
    describe("#polygon_removed", function () {
      beforeEach(function () {
        polygon_removed_event = GMaps.on(
          "polygon_removed",
          map_events,
          callbacks_gmaps.polygon_removed,
        );
      });

      it("should add the listener to the listeners collection", function () {
        expect(map_events.registered_events["polygon_removed"][0]).toEqual(
          polygon_removed_event,
        );
      });
