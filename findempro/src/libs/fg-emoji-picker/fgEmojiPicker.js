    ...
    openEmojiSelector(e) {
      ...
      if (el) {
        ...
        this.emojiPicker().then((emojiPicker) => {
          // Create node from
          const node = new DOMParser().parseFromString(emojiPicker, "text/html")
            .body.firstElementChild;
          ...
          document.body.querySelector(this.selectors.emojiPicker).onclick =
            function (e) {
              e.preventDefault();
              ...
              if (
                ...
                scrollTo(
                  emojiBody,
                  emojiBody.querySelector(`#${listIndex}`).offsetTop -
                    emojiPickerHeader.offsetHeight,
                );
              }
            };
        });
