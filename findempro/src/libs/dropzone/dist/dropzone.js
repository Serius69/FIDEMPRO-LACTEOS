...
var $b1d17cfb1d15c36a$export$2e2bcd8739ae039 = /*#__PURE__*/ (function () {
  ...
  function $b1d17cfb1d15c36a$export$2e2bcd8739ae039() {
    $6mU8w$swchelpers.classCallCheck(
      this,
...
var $b657c03155fc27e2$var$defaultOptions = {
   ...
   */ fallback: function () {
    ...
    if (!messageElement) {
      messageElement = $a601ff30f483e917$export$2e2bcd8739ae039.createElement(
   ...
   *       .innerHTML
   *
   */ previewTemplate: /*@__PURE__*/ $parcel$interopDefault(
    $69c61888cc1f4c57$exports,
  ),
  /*
  ...
  addedfile: function (file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      var _this = this;
      file.previewElement =
        $a601ff30f483e917$export$2e2bcd8739ae039.createElement(
      ...
      try {
        for (
          var _iterator1 = file.previewElement
      ...
      var removeFileEvent = function (e) {
        ...
        if (file.status === $a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING)
          return $a601ff30f483e917$export$2e2bcd8739ae039.confirm(
      ...
      try {
        for (
          var _iterator2 = file.previewElement
...
var $b657c03155fc27e2$export$2e2bcd8739ae039 =
  $b657c03155fc27e2$var$defaultOptions;

var $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ (function (
  Emitter,
) {
  "use strict";
  ...
  function $a601ff30f483e917$export$2e2bcd8739ae039(el, options) {
    $6mU8w$swchelpers.classCallCheck(
      this,
      $a601ff30f483e917$export$2e2bcd8739ae039,
    );
    var _this;
    _this = $6mU8w$swchelpers.possibleConstructorReturn(
      this,
      $6mU8w$swchelpers
        .getPrototypeOf($a601ff30f483e917$export$2e2bcd8739ae039)
        .call(this),
    );
    var fallback, left;
    _this.element = el;
    ...
    $a601ff30f483e917$export$2e2bcd8739ae039.instances.push(
      $6mU8w$swchelpers.assertThisInitialized(_this),
    );
    // Put the dropzone inside the element itself.
    _this.element.dropzone = $6mU8w$swchelpers.assertThisInitialized(_this);
    var elementOptions =
      (left = $a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement(
        _this.element,
      )) != null
        ? left
        : {};
    _this.options = $parcel$interopDefault($6mU8w$justextend)(
      true,
      {},
      $b657c03155fc27e2$export$2e2bcd8739ae039,
      elementOptions,
    ...
    if (
      ...
      !$a601ff30f483e917$export$2e2bcd8739ae039.isBrowserSupported()
    )
      return $6mU8w$swchelpers.possibleConstructorReturn(
        _this,
    ...
    if (_this.options.binaryBody && _this.options.uploadMultiple)
    ...
    if (_this.options.previewsContainer !== false) {
      if (_this.options.previewsContainer)
        _this.previewsContainer =
          $a601ff30f483e917$export$2e2bcd8739ae039.getElement(
    ...
    if (_this.options.clickable) {
      if (_this.options.clickable === true)
        ...
        _this.clickableElements =
          $a601ff30f483e917$export$2e2bcd8739ae039.getElements(
    ...
    [
      ...
      },
      {
        ...
        value: function getQueuedFiles() {
          return this.getFilesWithStatus(
            $a601ff30f483e917$export$2e2bcd8739ae039.QUEUED,
          );
        },
      },
      {
        ...
        value: function getUploadingFiles() {
          return this.getFilesWithStatus(
            $a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING,
          );
        },
      },
      {
        ...
        value: function getAddedFiles() {
          return this.getFilesWithStatus(
            $a601ff30f483e917$export$2e2bcd8739ae039.ADDED,
          );
        },
      },
      {
        ...
        value: function init() {
          ...
          if (this.clickableElements.length) {
            ...
            var setupHiddenFileInput = function () {
              ...
              $a601ff30f483e917$export$2e2bcd8739ae039
                .getElement(
                  _this.options.hiddenInputContainer,
                  "hiddenInputContainer",
                )
                .appendChild(_this.hiddenFileInput);
              _this.hiddenFileInput.addEventListener("change", function () {
                var _hiddenFileInput = _this11.hiddenFileInput,
                  files = _hiddenFileInput.files;
                var _iteratorNormalCompletion = true,
                  _didIteratorError = false,
                  _iteratorError = undefined;
                if (files.length)
          ...
          try {
            ...
            for (
              var _iterator = this.events[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
            ...
            return _this10.listeners.push({
              ...
              events: {
                click: function (evt) {
                  ...
                  if (
                    clickableElement !== _this11.element ||
                    evt.target === _this11.element ||
                    $a601ff30f483e917$export$2e2bcd8739ae039.elementInside(
                      evt.target,
                      _this11.element.querySelector(".dz-message"),
                    )
                  )
                    _this11.hiddenFileInput.click(); // Forward the click
                  return true;
                },
              },
            });
      ...
      },
      {
        ...
        value: function destroy() {
          ...
          return $a601ff30f483e917$export$2e2bcd8739ae039.instances.splice(
            $a601ff30f483e917$export$2e2bcd8739ae039.instances.indexOf(this),
            1,
          );
        },
      },
      {
        ...
        value: function updateTotalUploadProgress() {
          ...
          if (activeFiles.length) {
            ...
            try {
              for (
                var _iterator = this.getActiveFiles()[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
                var file = _step.value;
      ...
      },
      {
        ...
        value: function getFallbackForm() {
          ...
          if (this.element.tagName !== "FORM") {
            form = $a601ff30f483e917$export$2e2bcd8739ae039.createElement(
              '<form action="'
                .concat(
                  this.options.url,
      ...
      },
      {
        ...
        value: function getExistingFallback() {
          ...
          try {
            for (
              var _iterator = ["div", "form"][Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
      ...
      },
      {
        ...
        value: function drop(e) {
          ...
          if (files.length) {
            var _dataTransfer = e.dataTransfer,
      ...
      },
      {
        ...
        value: function paste(e) {
          if (
            $a601ff30f483e917$var$__guard__(
            ...
            try {
              for (
                ...
                if (
                  ...
                  if (entry.isFile)
                    result.push(_this.addFile(item.getAsFile()));
                  else if (entry.isDirectory)
                    // Append all files from that directory to files
                    result.push(
                      _this._addFilesFromDirectory(entry, entry.name),
                    );
      ...
      },
      {
        ...
        value: function _addFilesFromDirectory(directory, path) {
          ...
          var errorHandler = function (error) {
            return $a601ff30f483e917$var$__guardMethod__(
              console,
              "log",
              function (o) {
                return o.log(error);
                  ...
                  for (
                    ...
                    if (entry.isFile)
                      entry.file(function (file) {
                        if (
                          _this2.options.ignoreHiddenFiles &&
      ...
      },
      {
        ...
        value: function accept(file, done) {
          if (
            ...
            file.size > this.options.maxFilesize * 1048576
          )
            done(
            ...
            !$a601ff30f483e917$export$2e2bcd8739ae039.isValidFile(
              file,
      ...
      },
      {
        ...
        value: function addFile(file) {
          ...
          this.accept(file, function (error) {
            if (error) {
              file.accepted = false;
              _this._errorProcessing([file], error); // Will set the file.status
            } else {
              file.accepted = true;
      ...
      },
      {
        ...
        value: function _enqueueThumbnail(file) {
          if (
            ...
            file.type.match(/image.*/) &&
            file.size <= this.options.maxThumbnailFilesize * 1048576
          ) {
            var _this = this;
      ...
      },
      {
        ...
        value: function removeAllFiles(cancelIfNecessary) {
          ...
          try {
            for (
              var _iterator = this.files.slice()[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
              var file = _step.value;
            ...
            function (dataUrl, canvas) {
              if (canvas == null)
                ...
                var _options = _this.options,
                  resizeMimeType = _options.resizeMimeType;
                if (resizeMimeType == null) resizeMimeType = file.type;
                var resizedDataURL = canvas.toDataURL(
                  resizeMimeType,
                  _this.options.resizeQuality,
                );
                if (
                  ...
                  resizedDataURL = $a601ff30f483e917$var$ExifRestore.restore(
                    file.dataURL,
                    resizedDataURL,
                  );
                return callback(
                  $a601ff30f483e917$export$2e2bcd8739ae039.dataURItoBlob(
                    resizedDataURL,
                  ),
                );
              }
        ...
        value: function createThumbnailFromUrl(
          ...
          img.onload = function () {
            ...
            return loadExif(function (orientation) {
              ...
              var resizeInfo = _this1.options.resize.call(
                _this1,
                file,
                width,
                height,
              ...
              $a601ff30f483e917$var$drawImageIOSFix(
                ctx,
                img,
      ...
      },
      {
        ...
        value: function processQueue() {
          var _options = this.options,
            parallelUploads = _options.parallelUploads;
      ...
      },
      {
        ...
        value: function cancelUpload(file) {
          if (
            ...
            try {
              for (
                var _iterator = groupedFiles[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
                var groupedFile = _step.value;
                groupedFile.status =
                  $a601ff30f483e917$export$2e2bcd8739ae039.CANCELED;
              }
            } catch (err) {
              _didIteratorError = true;
              _iteratorError = err;
            ...
            try {
              for (
                var _iterator1 = groupedFiles[Symbol.iterator](), _step1;
          ...
          this._transformFiles(files, function (transformedFiles) {
            if (_this.options.chunking) {
              ...
              files[0].upload.chunked =
                ...
                (_this.options.forceChunking ||
                  transformedFile.size > _this.options.chunkSize);
            ...
            if (files[0].upload.chunked) {
              ...
              var handleNextChunk = function () {
                ...
                var end = Math.min(
                  start + _this1.options.chunkSize,
                ...
                _this1._uploadData(files, [dataBlock]);
              };
              file.upload.finishedChunkUpload = function (chunk, response) {
                ...
                for (var i = 0; i < file.upload.totalChunkCount; i++) {
                  ...
                  if (
                    ...
                    $a601ff30f483e917$export$2e2bcd8739ae039.SUCCESS
                  )
                    allFinished = false;
                }
                if (allFinished)
                  _this4.options.chunksUploaded(file, function () {
      ...
      },
      {
        ...
        value: function _uploadData(files, dataBlocks) {
          ...
          xhr.ontimeout = function () {
            _this7._handleUploadError(
              files,
              xhr,
              "Request timedout after ".concat(
                _this7.options.timeout / 1000,
                " seconds",
              ),
            );
          };
          ...
          if (this.options.headers)
            $parcel$interopDefault($6mU8w$justextend)(
              headers,
      ...
      },
      {
        ...
        value: function _transformFiles(files, done) {
          var _this = this,
            _loop = function (i) {
              _this.options.transformFile.call(
                _this,
                files[i],
              ...
              for (
                ...
                if (
                  ...
                  try {
                    ...
                    for (
                      var _iterator = input.options[Symbol.iterator](), _step;
                      !(_iteratorNormalCompletion = (_step = _iterator.next())
                        .done);
                      _iteratorNormalCompletion = true
                    ) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement = function (
  element,
) {
  // Get the `Dropzone.options.elementId` for this element if it exists
  if (element.getAttribute("id"))
    return $a601ff30f483e917$export$2e2bcd8739ae039.options[
      $a601ff30f483e917$var$camelize(element.getAttribute("id"))
    ];
...
$a601ff30f483e917$export$2e2bcd8739ae039.discover = function () {
  ...
  return (function () {
    ...
    try {
      for (
        var _iterator = dropzones[Symbol.iterator](), _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
        ...
        if (
          $a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement(
            dropzone,
          ) !== false
        )
          result.push(new $a601ff30f483e917$export$2e2bcd8739ae039(dropzone));
        else result.push(undefined);
      }
    } catch (err) {
      _didIteratorError = true;
...
$a601ff30f483e917$export$2e2bcd8739ae039.isBrowserSupported = function () {
  ...
  if (
    ...
    if (!("classList" in document.createElement("a"))) capableBrowser = false;
      ...
      if (
        $a601ff30f483e917$export$2e2bcd8739ae039.blacklistedBrowsers !==
        undefined
      )
...
$a601ff30f483e917$export$2e2bcd8739ae039.elementInside = function (
  element,
  container,
) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.getElements = function (els, name) {
  ...
  if (els instanceof Array) {
    ...
    try {
      ...
      try {
        for (
          var _iterator = els[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          el = _step.value;
    ...
    try {
      for (
        var _iterator = document.querySelectorAll(els)[Symbol.iterator](),
          _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.confirm = function (
  question,
  accepted,
  rejected,
) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.isValidFile = function (
  file,
  acceptedFiles,
) {
  ...
  try {
    for (
      var _iterator = acceptedFiles[Symbol.iterator](), _step;
      !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      _iteratorNormalCompletion = true
    ) {
...
// or uploading.
$a601ff30f483e917$export$2e2bcd8739ae039.ACCEPTED =
  $a601ff30f483e917$export$2e2bcd8739ae039.QUEUED;
$a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING = "uploading";
$a601ff30f483e917$export$2e2bcd8739ae039.PROCESSING =
  $a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING; // alias
...
var $a601ff30f483e917$var$detectVerticalSquash =
  function $a601ff30f483e917$var$detectVerticalSquash(img) {
    ...
    var ref = ctx.getImageData(1, 0, 1, ih),
      data = ref.data;
...
var $a601ff30f483e917$var$drawImageIOSFix =
  function $a601ff30f483e917$var$drawImageIOSFix(
    ctx,
    img,
    sx,
    sy,
...
var $a601ff30f483e917$var$contentLoaded =
  function $a601ff30f483e917$var$contentLoaded(win, fn) {
    var done = false;
    var top = true;
