!(function (e) {
  ...
  (a.dictionary = Object.assign(a.dictionary || {}, {
    ...
    "Could not insert image at the current position.":
      "No se pudo insertar la imagen en la posición actual.",
    "Could not obtain resized image URL.":
      "No se pudo obtener la URL de la imagen redimensionada.",
    ...
    "Selecting resized image failed":
      "No se pudo seleccionar la imagen redimensionada",
