...
const e = ({ addFilter: e, utils: E }) => {
  const { Type: i, replaceInString: _, toNaturalFileSize: l } = E;
  return (
    e("ALLOW_HOPPER_ITEM", (e, { query: E }) => {
      if (!E("GET_ALLOW_FILE_SIZE_VALIDATION")) return !0;
      const i = E("GET_MAX_FILE_SIZE");
      if (null !== i && e.size > i) return !1;
      const _ = E("GET_MIN_FILE_SIZE");
    ...
    e(
      ...
      (e, { query: E }) =>
        new Promise((i, I) => {
          ...
          const L = E("GET_FILE_VALIDATE_SIZE_FILTER");
          if (L && !L(e)) return i(e);
          const t = E("GET_MAX_FILE_SIZE");
          if (null !== t && e.size > t)
            return void I({
              status: {
          ...
          const T = E("GET_MAX_TOTAL_FILE_SIZE");
          if (null !== T) {
            if (E("GET_ACTIVE_ITEMS").reduce((e, E) => e + E.fileSize, 0) > T)
              return void I({
                status: {
