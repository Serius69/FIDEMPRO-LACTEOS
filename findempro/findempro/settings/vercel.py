...
ALLOWED_HOSTS = [
    '.vercel.app',
    'findempro-lacteos.vercel.app',  # Cambia esto por tu dominio
    'localhost',
]

# Base de datos - Usar PostgreSQL en producción
# Vercel no soporta MySQL, necesitas usar PostgreSQL externo
DATABASES = {
    'default': {
...
# Desactivar funciones que no funcionan en Vercel
