...
<div
  ...
  class="mb-3{% if 'form-horizontal' in form_class %} row{% endif %}{% if form_show_errors and field.errors %} error{% endif %}{% if field.css_classes %} {{ field.css_classes }}{% endif %}"
>
  <label
  ...
  <div class="{{ field_class }}">
    {% crispy_field field 'disabled' 'disabled' %} {% include
