...
class WorkingSet:
    ...
    def __iter__(self):
        """Yield distributions for non-duplicate products in the working set
    ...
    def find_plugins(
        ...
        plugin_products = list(plugin_env)
        # scan project names in alphabetic order
        plugin_products.sort()
        ...
        for project_name in plugin_products:
