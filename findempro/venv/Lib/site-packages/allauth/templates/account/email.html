...
"Email Addresses" %}{% endblock head_title %} {% block content %}
...
{% else %} {% include "account/snippets/warn_no_email.html" %} {% endif %} {% if
can_add_email %}
...
{% endif %} {% endblock content %} {% block extra_body %}
<script type="text/javascript">
  ;(function () {
    var message =
      "{% trans 'Do you really want to remove the selected email address?' %}"
