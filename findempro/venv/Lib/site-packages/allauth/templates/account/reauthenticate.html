...
"Confirm Access" %}{% endblock head_title %} {% block content %}

<h1>{% trans "Confirm Access" %}</h1>

<p
  >{% blocktranslate %}To safeguard the security of your account, please enter
  your password:{% endblocktranslate %}</p
>
