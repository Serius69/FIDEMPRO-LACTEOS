# simulate/utils/simulation_math_utils.py
"""
Motor matemático con ecuaciones hardcodeadas para resolución de dependencias.

DEPRECADO: Las ecuaciones específicas de sector deben almacenarse en la base de datos
(modelo Equation) y ejecutarse a través de simulate.core.discrete_engine.DiscreteEventEngine,
que las resuelve en orden topológico de forma genérica.

Este módulo se mantiene por compatibilidad con simulate_result_view.py mientras
se completa la migración a la nueva arquitectura core/.
"""
import logging
import re
import numpy as np
