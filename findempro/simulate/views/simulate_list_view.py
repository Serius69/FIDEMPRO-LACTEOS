...
class SimulateAddView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        """Create new simulation and dispatch async execution"""
        try:
            ...
            # Dispatch execution after the DB record is committed
            sim_id = simulation_instance.id
            transaction.on_commit(lambda: execute_simulation_async.delay(sim_id))

            messages.success(request, "Simulación creada. Procesando en segundo plano...")
