...
from finance.views import (
    finance_list_view,
    create_finance_decision_view,
    update_finance_decision_view,
...
urlpatterns = [
    ...
    path("create/", view=create_finance_decision_view, name='finance.create'),
    path("update/<int:pk>/", view=update_finance_decision_view, name='finance.edit'),
