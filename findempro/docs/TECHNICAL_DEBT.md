...
| Estado | Evidencia |
|---|---|
| 0 abiertos observados | Suite Django **1046/1046** (1002 previos + 44 de honestidad estadística/financiera); `check` limpio; `makemigrations --check --dry-run` sin cambios. |
